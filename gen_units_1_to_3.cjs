...
const UNIT_1 = {
  ...
  description: 'Khám phá các làng nghề thủ công mỹ nghệ, kỹ năng giao tiếp trong cộng đồng, cụm động từ (Phrasal Verbs) và từ để hỏi trước To-infinitive.',
  pronunciationFocus: 'Ngữ âm: Nhấn trọng âm ở cụm động từ (Phrasal verbs) và ngữ điệu câu hỏi thông tin',
  badgeIconName: 'Users',
  vocabulary: [
  ...
  grammar: {
    ...
    formulaBox: [
      'Phrasal Verb = Verb + Particle (pass down, look after, turn up, find out, set off, live on)',
...
// Write Unit 1
fs.writeFileSync('src/data/units/unit1.ts', 'import { UnitData } from "../../types";\n\nexport const UNIT_1_DATA: UnitData = ' + JSON.stringify(UNIT_1, null, 2) + ';\n');
console.log("Unit 1 generated with 20 vocab, 20 grammar, 8 listening, 4 fill-in-blanks, 20 speaking, 10 reading, 5 writing!");
